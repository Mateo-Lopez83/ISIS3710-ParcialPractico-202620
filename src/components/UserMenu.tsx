  ...
  if (session.id) {
    return (
      <div className="flex items-center gap-6">
        <Link href="/plans/newplan" className="bg-blue-600 text-white text-lg font-semibold rounded-xl px-6 py-3 cursor-pointer">
           + Crear Plan
        </Link>
        ...
        <button id="LogOut" onClick={handleLogout} className="text-slate-500">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
